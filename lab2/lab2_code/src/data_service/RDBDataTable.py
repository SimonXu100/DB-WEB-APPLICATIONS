...
class RDBDataTable():
    ...
    def get_row_count(self):
        ...
        # -- TO IMPLEMENT --
        q = "select  count(*) as num_of_rows from  " + self._full_table_name
        res, data = dbutils.run_q(q, conn=self._cnx)
        data = data[0].get("num_of_rows")
    ...
    def get_primary_key_columns(self):
        ...
        for i in data:
            key_columns_temp.append(i['Column_name'])
        self._key_columns = key_columns_temp
    ...
    def update_by_template(self, template, new_values):
        ...
        res, d = dbutils.run_q(sql, args=args, conn=self._cnx, commit=True)
        print("the result of res in template  ", res)
        print("the result of d in template  ", d)
        return res
    ...
    # you do not need to worry about the following part
